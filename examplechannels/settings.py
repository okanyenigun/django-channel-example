"""
Django settings for examplechannels project.
...
SECRET_KEY = 'django-insecure-!dhbu*+_1l$o-q#zngw)m_m#kboz(&r9540292+p#2qz48n1ub'
...
ROOT_URLCONF = 'examplechannels.urls'
